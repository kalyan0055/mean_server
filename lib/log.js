...
log4js.configure({
    appenders: [
    {
        ...
        maxLogSize: 50*1024,
        backups: 5,
        category: ['CRON', 'MAIL', 'USERS', 'SENDMAIL', 'API', 'COMPANY', 'Leads', 'MESSAGES', 'OFFERS', 'ORDERS', 'Product', 'Todo', 'REPORT', 'NOTIFICATION', 'UNITOFMEASURE', 'STOCKMASTER', 'TAXGROUP', 'IMPORTFILE','CONTACT','GROUP','ACTIVITIES']
    },
    {
        type: 'console'
    }],
